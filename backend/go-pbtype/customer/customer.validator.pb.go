...
import (
	...
	_ "github.com/nekizz/final-project/backend/go-pbtype/user"
...
func (this *CheckLoginCustomerRequest) Validate() error {
	return nil
}
func (this *CustomerAccountRequest) Validate() error {
	return nil
}
